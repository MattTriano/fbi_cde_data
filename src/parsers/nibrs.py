        ...
        record.update(
            {
                ...
                "fbi_field_office": self.line[89:92],
                "judicial_district": self.line[92:96],
        ...
        record.update(
            {
                ...
                "months_reported": self.line[51 + self.offset : 53 + self.offset],
...
class SegmentBHParserV0:
    ...
    def unpack_record(self) -> dict:
        return {
            ...
            "nibrs_flag": self.line[96:97],
            "inactive_date": self.line[97:105],
            "city1_curr_pop": self.line[105:114],
            "city1_code_ucr": self.line[114:117],
            "city1_msa_code": self.line[117:120],
            "city1_last_pop": self.line[120:129],
            "city2_curr_pop": self.line[129:138],
            "city2_code_ucr": self.line[138:141],
            "city2_msa_code": self.line[141:144],
            "city2_last_pop": self.line[144:153],
            "city3_curr_pop": self.line[153:162],
            "city3_code_ucr": self.line[163:165],
            "city3_msa_code": self.line[166:168],
            "city3_last_pop": self.line[168:177],
            "city4_curr_pop": self.line[177:186],
            "city4_code_ucr": self.line[186:189],
            "city4_msa_code": self.line[189:192],
            "city4_last_pop": self.line[192:201],
            "city5_curr_pop": self.line[201:210],
            "city5_code_ucr": self.line[210:213],
            "city5_msa_code": self.line[213:216],
            "city5_last_pop": self.line[216:225],
            "ind_1_6_12": self.line[225:227],
            "months_reported": self.line[227:229],
...
class SegmentW3Parser(Segment03Parser):
    ...
    def unpack_w3_fields(self) -> dict:
        return {
            ...
            "ucr_offense4": self.line[111:114],
            "ucr_offense5": self.line[114:117],
            "ucr_offense6": self.line[117:120],
