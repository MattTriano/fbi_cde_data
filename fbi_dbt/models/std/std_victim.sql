...
with victim_seg as (
    select distinct on (nibrs_year, ori, incident_no, incident_date, victim_seq_no)
        ...
        {{ trim_and_stdize_nulls('victim_seq_no') }}                 as victim_seq_no,
